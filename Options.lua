...
local function buildOptions()
	if not loaded then
		...
		addCheckButton( "guiShowNormalWotLKDaily", SHOW.." Wotlk "..LFG_TYPE_DUNGEON.." "..DAILY, "", Reputable_Data.global, "guiShowNormalWotLKDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowHeroicWotLKDaily", SHOW.." Wotlk "..LFG_TYPE_HEROIC_DUNGEON.." "..DAILY, "", Reputable_Data.global, "guiShowHeroicWotLKDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowWotlkCookingDaily", SHOW.." Wotlk "..PROFESSIONS_COOKING.." "..DAILY, "", Reputable_Data.global, "guiShowWotlkCookingDaily", function() config:guiUpdate(true) end )
		addCheckButton( "guiShowWotlkFishingDaily", SHOW.." Wotlk "..PROFESSIONS_FISHING.." "..DAILY, "", Reputable_Data.global, "guiShowWotlkFishingDaily", function() config:guiUpdate(true) end )
